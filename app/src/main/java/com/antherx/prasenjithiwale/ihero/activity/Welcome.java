...
import com.antherx.prasenjithiwale.ihero.important.PrefManger;
...
public class Welcome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!prefManager.isWelcomeLaunch()) {
            launchHomeScreen();
            finish();
        }
    ...
    private void launchHomeScreen() {
        prefManager.setWelcomeLaunch(false);
        startActivity(new Intent(Welcome.this, MainHome.class));
        finish();
    }
